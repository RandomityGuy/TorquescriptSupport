...
- [src/torquescript.langium](src/torquescript.langium) -  The grammar definition of your language
- [src/torquescript-module.ts](src/torquescript-module.ts) - The dependency injection module of your language implementation. Use this to register overridden and added services.
- [src/torquescript-validator.ts](src/torquescript-validator.ts) - An example validator. You should change it to reflect the semantics of your language.
...
- [src/syntaxes/torquescript.monarch.ts](src/syntaxes/torquescript.monarch.ts) - Monarch based syntax highlighting instructions.
- [syntaxes/torquescript.tmLanguage.json](syntaxes/torquescript.tmLanguage.json) - Textmate based syntax highlighting instructions.
